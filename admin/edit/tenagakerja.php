    ...
    <form class="form-horizontal form-edit no-padding" role="form">
    <legend class="legend">Tenaga Kerja  </legend>
        <div class="form-group padding">
            <div class="col-md-6">
                <div class="row form-group"> 
                    <label for="inputgred" class="col-sm-5 control-label">   Nama   </label>
                    <div class="col-xs-1 col-dot-edit-2 no-margin ">:</div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-edit"  id="">
                    </div>
                </div>
                <div class="row form-group">
                    <label for="inputtahun" class="col-sm-5 control-label">    Tempat/Tanggal Lahir </label>
                    <div class="col-xs-1 col-dot-edit-2 no-margin ">:</div>    
                    <div class="col-sm-5">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-xs-1 col-dot-edit-2 no-margin ">:</div>
                    <div class="col-sm-6">
                        <textarea class="form-control form-control-edit" rows="3" id=""></textarea>
                    </div>
                </div>
                <div class="row form-group">
            ...
            <div class="col-md-6 ">
                <div class="row form-group">
                    <label for="inpuNPWP" class="col-sm-4 control-label"> PJT </label>
                ...
                <div class="row form-group">
                    <label for="inpuNPWP" class="col-sm-4 control-label">  PJB </label>
                    <div class="col-xs-1 col-dot-edit-2 ">:</div>
                    <div class="col-sm-4">
                        <input type="type" placeholder="" class="form-control form-control-edit" id="">
                    </div>
                ...
                <div class="row form-group">
                    <label for="inpuNPWP" class="col-sm-4 control-label"> No. Regristrasi </label>
                    <div class="col-xs-1 col-dot-edit-2 ">:</div>
                    <div class="col-sm-3">
                        <input type="type" placeholder="" class="form-control form-control-edit" id="">
                    </div>
                ...
                <div class="row form-group">
                    <label for="inpuNPWP" class="col-sm-4 control-label">  Jenis Sertifikat </label>
                    <div class="col-xs-1 col-dot-edit-2 ">:</div>
                    <div class="col-sm-4">
                        <input type="type" placeholder="" class="form-control form-control-edit" id="">
                    </div>
        ...
        <div class="form-group padding">
            ...
            <div class="col-md-6">
                <div class="row form-group">
                 <label for="inpuNPWP" class="col-sm-4 control-label">  Pendidikan </label>
                 <div class="col-xs-1 col-dot-edit-2 ">:</div>
                 <div class="col-sm-3">
        ...
        <div class="form-group padding margin-down">
            <div class=" col-sm-9">
                <button class="btn btn-primary pull-right" type="button">Register</button>
            </div>
            <div class=" col-sm-3">
                <button class="btn btn-primary pull-right" type="button">Tambah Data Tenaga Kerja</button>
            </div>
        </div>
    </form>
    </div>
